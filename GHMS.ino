...
void connectToThingSpeak(){
  ...
  if (waitResponse("CONNECT OK")) {
    ...
    String data = "api_key=" + String(API_KEY)+ "&field1=" + String(temperature) + "&field2=" + String(humidity) + "&field3=" + String(level) + "&field4=" + String(moistureValue) + "&field5=" + String(smokeValue) + "&field6=" + String(lightVal);
...
void smokeSensor() {
  smokeValue = analogRead(MQ2pin);  // read analog input pin 0
